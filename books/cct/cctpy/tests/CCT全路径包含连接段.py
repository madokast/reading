...
if __name__ == "__main__":
    ...
    if True: # 四极CCT内层
        ...
        # conn
        fp = fp.append(connector34_p2_fun,start=connector_34_in.p2_function_start ,end=connector_34_in.p2_function_end,scale=10)
        # 4
        fp = fp.append(p2_func4,start=agcct4_in.starting_point_in_ksi_phi_coordinate.x,end=agcct4_in.end_point_in_ksi_phi_coordinate.x)
        fp = fp.append(connector45_p2_fun,start=connector_45_in.p2_function_start ,end=connector_45_in.p2_function_end,scale=10)
        fp = fp.append(p2_func5,start=agcct5_in.starting_point_in_ksi_phi_coordinate.x,end=agcct5_in.end_point_in_ksi_phi_coordinate.x)
    ...
    if True: # 四极CCT外层
        ...
        # conn
        fp = fp.append(connector34_p2_fun,start=connector_34_out.p2_function_start ,end=connector_34_out.p2_function_end,scale=10)
        # 4
        fp = fp.append(p2_func4,start=agcct4_out.starting_point_in_ksi_phi_coordinate.x,end=agcct4_out.end_point_in_ksi_phi_coordinate.x)
        fp = fp.append(connector45_p2_fun,start=connector_45_out.p2_function_start ,end=connector_45_out.p2_function_end,scale=10)
        fp = fp.append(p2_func5,start=agcct5_out.starting_point_in_ksi_phi_coordinate.x,end=agcct5_out.end_point_in_ksi_phi_coordinate.x)
